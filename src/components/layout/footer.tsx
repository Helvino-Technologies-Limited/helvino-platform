      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">
              ...
              cybersecurity, networking, and surveillance systems.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-sm text-gray-300 hover:text-helvino-orange transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-sm text-gray-300 hover:text-helvino-orange transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/projects" className="text-sm text-gray-300 hover:text-helvino-orange transition-colors">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-sm text-gray-300 hover:text-helvino-orange transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/reviews" className="text-sm text-gray-300 hover:text-helvino-orange transition-colors">
                  Reviews
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-sm text-gray-300">
                ...
                <a href="mailto:helvinotechltd@gmail.com" className="hover:text-helvino-orange transition-colors">
                  helvinotechltd@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-2 text-sm text-gray-300">
                <Phone className="h-4 w-4 text-helvino-orange" />
                <a href="tel:0703445756" className="hover:text-helvino-orange transition-colors">
                  0703 445 756
                </a>
              </li>
              <li className="flex items-center space-x-2 text-sm text-gray-300">
              ...
              <li className="flex items-center space-x-2 text-sm text-gray-300">
                <Linkedin className="h-4 w-4 text-helvino-orange" />
                  ...
                  className="hover:text-helvino-orange transition-colors"
                >
                  LinkedIn
                </a>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Helvino Technologies Limited. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
